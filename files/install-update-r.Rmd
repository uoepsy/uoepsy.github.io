...
subtitle: "Last updated: UN - July 2022 for R version 4.2.1"
author: "PPLS Psychology Statistics"
output:
  html_document:
    theme: cosmo
    toc: true
...
- Click __Download R-4.2.1 for Windows__
...
1. `R-4.2.1.pkg (notarized and signed)` if you have an Intel-based macOS PC
2. `R-4.2.1-arm64.pkg (notarized and signed)` if you have an Apple silicon arm64 macOS PC.
