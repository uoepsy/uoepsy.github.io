...
- Click __Download R-4.4.0 for Windows__
...
- Click __RTools 4.4__
- Click __Rtools44 installer__
- Open the installer and follow the instructions while keeping the default options
...
1. `R-4.4.0-arm64.pkg` if you have an Apple silicon arm64 macOS PC.
2. `R-4.4.0-x86_64.pkg` if you have an Intel-based macOS PC
