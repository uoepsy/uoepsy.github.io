...
2.  Install R
    ...
    -   Go to <https://cran.r-project.org/bin/macosx/> and download:
        -   `R-4.6.1-arm64.pkg` if you have an Apple silicon arm64 macOS PC.
        -   `R-4.6.1-x86_64.pkg` if you have an Intel-based macOS PC
    -   Open the installer and follow the instructions while keeping the default options.
3.  Install RStudio
    -   Go to <https://posit.co/download/rstudio-desktop/>, ignore the "install R" stuff (you've done that already). In the table of RStudio installers, find the one for your operating system and download it.\
    -   Open the installer and follow the instructions while keeping the default options.
...
<!-- 4. (Optional) Install XQuartz -->
<!--     -   Download XQuartz: <https://www.xquartz.org/> -->
<!--     -   Open the installer and follow the instructions while keeping the default options -->

### Chromebooks/Ipads etc

Installing R or RStudio on Ipads is not possible, and on Chromebooks it requires quite a lot of work. 
...
Instead, for your work on the statistics courses in the psychology department, you can use RStudio on the PPLS Server:  
...
## Optional (Windows PCs)

If you use a Windows PC and are trying to install packages which are not on CRAN, follow the additional steps below to install RTools:

1.  Go to <https://cran.r-project.org/bin/windows/Rtools/>
2.  Click **RTools 4.5**
3.  Click **Rtools45 installer**
4.  Open the installer and follow the instructions while keeping the default options

## History

-   Last updated by JK in September 2026 for R version 4.6.1
